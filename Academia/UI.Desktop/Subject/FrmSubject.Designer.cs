namespace UI.Desktop.Subject
{
    partial class FrmSubject
    {
		...
		private void InitializeComponent()
		{
			...
			// lstSubjects
			// 
			lstSubjects.Columns.AddRange(new ColumnHeader[] { description, curriculumDescription, level, weeklyHours, totalHours });
			lstSubjects.FullRowSelect = true;
			lstSubjects.Location = new Point(27, 187);
			lstSubjects.Name = "lstSubjects";
			lstSubjects.Size = new Size(950, 216);
			lstSubjects.TabIndex = 15;
